...
function HeroImage() {
  return (
    <div className="mt-4 relative flex justify-center items-center xl:items-center xl:p-0 w-3/4 md:w-[25rem] md:mt-0">
      <div className="flex items-center gap-2 text-slate-600 dark:text-slate-100 z-20 text-sm md:text-lg absolute bottom-0 bg-white p-2 shadow-card dark:bg-slate-700">
